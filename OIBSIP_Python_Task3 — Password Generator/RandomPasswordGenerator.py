...
show_password_checkbox = tk.Checkbutton(frame, text="Show Password", variable=show_password_var,
                                        command=toggle_password_visibility, bg="#f0f0f0", font=("Helvetica", 10))
show_password_checkbox.grid(row=7, column=0, columnspan=2, pady=2)

# Strength label
strength_label = tk.Label(frame, text="Strength: ", bg="#f0f0f0", font=("Helvetica", 12))
